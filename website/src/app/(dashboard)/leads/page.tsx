...
import { 
  ...
  Plus, X, MessageSquare, Send, Layers
} from "lucide-react";

export default function LeadsPage() {
  const { leads, enrichLead, sendOutreachAction, updateLeadStatus, scanReport, leadLists, createLeadList, generateAIMessage } = useAppState();
  ...
  const filteredLeads = leads.filter(l => {
    ...
    if (activeList) {
      return matchesSearch; // In real app, filter by list membership
    }
